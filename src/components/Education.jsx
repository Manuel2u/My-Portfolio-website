...
function Education() {
  return (
    <div className="bg-darkBlue sm:pb-10 md:pb-24">
      <div className="text-center py-16">
        <h3 className="text-white font-bold pb-4 text-3xl">
          My<span className="text-primary"> Education</span>
        </h3>
        <p className="text-white">
          About my education and qualification that I have
        </p>
      </div>
      <div className="md:flex px-16 mt-6">
        ...
        <div className="md:pl-10 sm:pl-0  sm:w-80 my-14  md:mx-5 md:w-[50%]">
          ...
          <p className="text-darktxt pb-3">
            I attended High School at Odorgonno Senior High School in the year
            2018 and completed my Senior High School Certificate Examination in
            the year 2021. .I studied General Science in my Senior High School.
            Member of the Robotics Club. I was the Class Prefect of my class in
            the year 2020 till completion.
          </p>
